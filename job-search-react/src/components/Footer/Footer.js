			...
			<div className="row footer1">
				<div className="container">
					...
					<span className="fa-stack fa-2x icons">
						...
						<a className="footer-font-awesome" title="Twitter" target="_blank" rel="noopener noreferrer"
							href="https://twitter.com/vetswhocode"><i className="fab fa-twitter fa-stack-1x"></i></a>
					</span>
					<span className="fa-stack fa-2x icons">
						<i className="fas fa-circle fa-stack-2x"></i>
						<a className="footer-font-awesome" title="Facebook" target="_blank" rel="noopener noreferrer"
							href="https://www.facebook.com/TheOfficialVetsWhoCode/"><i className="fab fa-facebook-f fa-stack-1x"></i></a>
					</span>
					<span className="fa-stack fa-2x icons">
						<i className="fas fa-circle fa-stack-2x"></i>
						<a className="footer-font-awesome" title="Github" target="_blank" rel="noopener noreferrer"
							href="https://github.com/Vets-Who-Code"><i className="fab fa-github fa-stack-1x"></i></a>
					</span>
					<span className="fa-stack fa-2x icons">
						<i className="fas fa-circle fa-stack-2x"></i>
						<a className="footer-font-awesome" title="Linkedin" target="_blank" rel="noopener noreferrer"
							href="https://www.linkedin.com/company/vets-who-code/"><i className="fab fa-linkedin-in fa-stack-1x"></i></a>
					</span>
					<span className="fa-stack fa-2x icons">
						<i className="fas fa-circle fa-stack-2x"></i>
						<a className="footer-font-awesome" title="Dev" target="_blank" rel="noopener noreferrer"
							href="https://dev.to/vetswhocode"><i className="fab fa-dev fa-stack-1x"></i></a>
					</span>
				</div>
			</div>
			<div className="row footer2">
				<div className="container">
					<div className="col-md-4 footer-div1">
						...
						<p className="footer-p">FRAGO, doing business as #VetsWhoCode, is an exempt organization as described in
					...
					<div className="col-md-4 footer-div3">
						...
						<div className="row">
							<div className="col-md-6 site-map">
								<ul>
									<li className="footer-li"><i className="far fa-circle fa-xs footer-icon"></i><a className="site-link"
							...
							<div className="col-md-6 site-map2">
								<ul>
									...
									<li className="footer-li"><i className="far fa-circle fa-xs footer-icon"></i><a className="site-link" href="">JOB
											SEARCH</a></li>
									<li className="footer-li"><i className="far fa-circle fa-xs footer-icon"></i><a className="site-link"
					...
					<div className="col-md-4 footer-div2">
						...
						<form id="contact-form">
							...
							<button type="submit" className="btn btn-primary send-button" id="send-button">Send</button>
						</form>
					</div>
				</div>
			</div>

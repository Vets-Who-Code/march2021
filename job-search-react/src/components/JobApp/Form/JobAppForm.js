...
export default function JobAppForm(props) {
        return (
                <form id="job-search" class="form-inline text-center job-grabber" onSubmit={(event) => props.submitForm(event)}>
                        ...
                        <label class="form-check-label" for="inlineFormCheck">Remote?</label>
